...
for (i in 1:length(ensemble_variants)) {
  ...
  #coef(ensemble$ens_model$finalModel, ensemble$ens_model$bestTune$lambda)
  ...
  model_identifiers <- c("ensemble", "gbm", "glmnet", "keras", "kernlab", "randomForestSRC")
  model_labels <- c("Ensemble", "Gradient boosting", "Logistic regression", "Neural net", "SVM", "Random Forest")
